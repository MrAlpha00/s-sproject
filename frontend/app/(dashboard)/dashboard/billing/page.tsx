  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.04] bg-zinc-900/20 p-6 md:p-8">
        ...
        <h1 className="text-xl md:text-2xl font-bold tracking-tight text-white">Billing</h1>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-zinc-900/40 p-12 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-sm font-semibold text-white">Billing & Subscriptions</h3>
        <p className="mt-1.5 text-xs text-zinc-500 max-w-sm leading-relaxed">
          Upgrade your plan, view usage-based invoicing tiers, and update corporate credit cards. Payment gateways will connect in a future module.
        </p>
      </div>
    </div>
  );
